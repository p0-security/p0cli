...
export const extractConnectionDetails = async (
    ...
    try {
        ...
        const integrationType =
            (perm.integrationType as string) ||
            (resource.integrationType as string);
        ...
        const region =
            (perm.region as string) || (resource?.region as string);
        const databaseName =
        ...
        const port =
            (perm.port as number) || (resource?.port as number) || 5432;
